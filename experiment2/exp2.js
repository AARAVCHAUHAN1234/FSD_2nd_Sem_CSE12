...
function DISPLAY(){
    ...
    for(let i=0;i<arr.length;i++){
        output+=`<p>Name: ${arr[i].name}, Age: ${arr[i].age}, Department: ${arr[i].department}, Salary: ${arr[i].salary}</p>`;
    }
...
function average(){
    ...
    document.getElementById("output").innerHTML="<p>Average Salary: " + average + "</p>";   
}
